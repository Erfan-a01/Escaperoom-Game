...
urlpatterns = [
    ...
    path('admin-add-room', views.admin_add_room_view, name='owner-add-room'),
    ...
    path('admin-add-question', views.admin_add_question_view, name='owner-add-question'),
    path('admin-view-question', views.admin_view_question_view, name='owner-view-question'),
